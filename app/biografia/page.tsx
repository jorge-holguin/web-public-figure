      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div className="mt-8 space-y-12">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-6">
            <Image src={estudios_superiores} alt="Estudios Superiores" className="w-48 rounded-lg shadow-md" />
            <div>
              <p className="mt-2 text-lg text-gray-500 dark:text-gray-300">
          ...
          <Image src={valer_colombia} alt="Estudios Superiores" className="w-48 rounded-lg shadow-md" />
              <p className="mt-2 text-lg text-gray-500 dark:text-gray-300">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-6">
              <Image src={valer_colombia_conferencia} alt="Estudios Superiores" className="w-48 rounded-lg shadow-md" />
              <p className="mt-2 text-lg text-gray-500 dark:text-gray-300">
          ...
          <div className="flex flex-col lg:flex-row-reverse items-start gap-6">
              <Image src={valer_bus} alt="Estudios Superiores" className="w-48 rounded-lg shadow-md" />
              <p className="mt-2 text-lg text-gray-500 dark:text-gray-300">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-6">
              <Image src={valer_paris} alt="Estudios Superiores" className="w-48 rounded-lg shadow-md" />
              <p className="mt-2 text-lg text-gray-500 dark:text-gray-300">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-6">
          <Image src={experiencia_laboral} alt="Estudios Superiores" className="w-48 rounded-lg shadow-md" />
              <p className="mt-2 text-lg text-gray-500 dark:text-gray-300">
          ...
          <div className="flex flex-col lg:flex-row-reverse items-start gap-6">
          <Image src={valer_agropecuario} alt="Estudios Superiores" className="w-48 rounded-lg shadow-md" />
              <p className="mt-2 text-lg text-gray-500 dark:text-gray-300">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-6">
              <Image src={valer_naciones_unidas} alt="Estudios Superiores" className="w-48 rounded-lg shadow-md" />
              <p className="mt-2 text-lg text-gray-500 dark:text-gray-300">
          ...
          <div className="flex flex-col lg:flex-row-reverse items-start gap-6">
              <Image src={valer_BID} alt="Estudios Superiores" className="w-48 rounded-lg shadow-md" />
              <p className="mt-2 text-lg text-gray-500 dark:text-gray-300">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-6">
              <Image src={valer_evo} alt="Estudios Superiores" className="w-48 rounded-lg shadow-md" />
              <p className="mt-2 text-lg text-gray-500 dark:text-gray-300">
          ...
          <div className="flex flex-col lg:flex-row-reverse items-start gap-6">
              <Image src={valer_retorno_peru} alt="Estudios Superiores" className="w-48 rounded-lg shadow-md" />
              <p className="mt-2 text-lg text-gray-500 dark:text-gray-300">
